...
$type_api_json = "";
$userPrompt    = $argv[1]??"Generate an image of a beautiful landscape bathed in the soft glow of dawn. In the foreground, a tranquil lake mirrors the warming hues of the sunrise";
...
echo "$userPrompt $number_output $type_api \r\n";
...
$prompt["6"]["inputs"]["text"]       = $userPrompt;
